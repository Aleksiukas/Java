...
//skaicius '2' ir skaicius "3" yra geri skaiciai
const du = 2;
const trys = 'trys'
...
//sarasu operacijos (array, masyvas, matrica)

const pazymiai = [ 10, 8 , 7, 6];
const abc = ['a', 'b', 'c', 'd', 'e'];
...
console.log('pirma raide:', abc[2]);
console.log('trecia raide:', abc[ 4]);
console.log('ketvirta raide:', abc[5]);
